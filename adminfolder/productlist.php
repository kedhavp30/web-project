  ...
  foreach($products as $product) {
    ...
    $allProducts .= <<<HTML
      <tr id="{$product['productId']}">
        ...
        <td>
          <button type="button" class="edit-product btn btn-outline-info btn-circle btn-lg btn-circle"><i class="fa fa-edit"></i></button>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <a class="add-product-link" href="addeditproduct.html">Add New Product</a>
              </div>
